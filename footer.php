...
<div class="container">
     <div class="copyright-txt"><?php echo esc_html('&copy; Copyright '.date('Y').' All Rights Reserved.');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-modern-kitchen-wordpress-theme');?>" target="_blank">
